    ...
    with Session(engine) as session:
        try:
            ...
            avg_prices_subq = (
                select(
                    ...
                    func.avg(
                        case(
                            (
                                op_ap.c.recorded_at >= datetime.now(UTC) - timedelta(days=7),
                                op_ap.c.price,
                            ),
                            else_=None,
                        )
                    ...
                    func.avg(
                        case(
                            (
                                op_ap.c.recorded_at >= datetime.now(UTC) - timedelta(days=30),
                                op_ap.c.price,
                            ),
                            else_=None,
                        )
                    ...
                    func.avg(
                        case(
                            (
                                op_ap.c.recorded_at >= datetime.now(UTC) - timedelta(days=90),
                                op_ap.c.price,
                            ),
                            else_=None,
                        )
                    ...
                    func.avg(
                        case(
                            (
                                op_ap.c.recorded_at >= datetime.now(UTC) - timedelta(days=180),
                                op_ap.c.price,
                            ),
                            else_=None,
                        )
                    ...
                    func.avg(
                        case(
                            (
                                op_ap.c.recorded_at >= datetime.now(UTC) - timedelta(days=365),
                                op_ap.c.price,
                            ),
                            else_=None,
                        )
            ...
            main_query = select(
                ...
                (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_7_days).label("difference_7_days_mean"),
                (
                    (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_7_days)
                    / func.nullif(avg_prices_subq.c.avg_price_7_days, 0)
                    * 100
                ).label("difference_7_days_mean_percentage"),
                (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_30_days).label("difference_30_days_mean"),
                (
                    (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_30_days)
                    / func.nullif(avg_prices_subq.c.avg_price_30_days, 0)
                    * 100
                ).label("difference_30_days_mean_percentage"),
                (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_90_days).label("difference_90_days_mean"),
                (
                    (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_90_days)
                    / func.nullif(avg_prices_subq.c.avg_price_90_days, 0)
                    * 100
                ).label("difference_90_days_mean_percentage"),
                (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_180_days).label("difference_180_days_mean"),
                (
                    (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_180_days)
                    / func.nullif(avg_prices_subq.c.avg_price_180_days, 0)
                    * 100
                ).label("difference_180_days_mean_percentage"),
                (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_365_days).label("difference_365_days_mean"),
                (
                    (current_prices_subq.c.current_price - avg_prices_subq.c.avg_price_365_days)
                    / func.nullif(avg_prices_subq.c.avg_price_365_days, 0)
                    * 100
                ).label("difference_365_days_mean_percentage"),
            ).select_from(current_prices_subq.join(avg_prices_subq, current_prices_subq.c.uri == avg_prices_subq.c.uri))
            ...
            updates = [
                {
                    ...
                    "difference_7_days_mean_percentage": diffs["difference_7_days_mean_percentage"],
                    "difference_30_days_mean": diffs["difference_30_days_mean"],
                    "difference_30_days_mean_percentage": diffs["difference_30_days_mean_percentage"],
                    "difference_90_days_mean": diffs["difference_90_days_mean"],
                    "difference_90_days_mean_percentage": diffs["difference_90_days_mean_percentage"],
                    "difference_180_days_mean": diffs["difference_180_days_mean"],
                    "difference_180_days_mean_percentage": diffs["difference_180_days_mean_percentage"],
                    "difference_365_days_mean": diffs["difference_365_days_mean"],
                    "difference_365_days_mean_percentage": diffs["difference_365_days_mean_percentage"],
                }
