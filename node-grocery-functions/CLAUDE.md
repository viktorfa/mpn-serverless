...
This is a project for some Node Lambda functions for a price comparison website. 
We recently migrated from MongoDB Postgres, and some responsibilities have been moved from this project to others.
